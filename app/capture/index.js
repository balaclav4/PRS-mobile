...
export default function CaptureScreen() {
  ...
  const pickPhoto = useCallback(async () => {
    try {
      ...
      if (!perm.granted) {
        const msg = 'Photo library access is needed to import a target. Enable it in Settings for Brass & Ballistics.';
  ...
  const takePhoto = useCallback(async () => {
    try {
      ...
      if (!perm.granted) {
        const msg = 'Camera access is needed to photograph targets. Enable it in Settings for Brass & Ballistics.';
